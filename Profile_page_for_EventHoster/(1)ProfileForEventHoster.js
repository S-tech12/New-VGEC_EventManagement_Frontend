    ...
    try {
        ...
        if (response.ok) {
            ...
            document.getElementById("UserData").innerHTML = `
                ...
                <strong>Role :</strong> Event Hoster<br><br>
            `;
            ...
            // this is for the query input email::
...
async function addInfo() {
    ...
    try {
        const response = await fetch("https://new-vgec-eventmanagement-backend.onrender.com/addInfo", {
            method: "PUT",
            headers: {
        ...
        if (response.ok) {
            ...
            successBox.innerHTML = `🎉 Congratulations! You have updated your profile. Now you can Go to <a href="../DashBoardForEventHoster/DashBoard.html" class="alert-link">Dashboard</a>.
            `;
